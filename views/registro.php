...
<body>
  ...
  <main>
    <form id="registration-form" action="index_logeado.php" onsubmit="validarFormularioRegistro(event)">
      ...
      <div class="form-alineado">
        ...
        <input id="ciudad" name="ciudad" title="Solo se permiten letras y espacios. Mínimo 2 caracteres." />
      </div>
      <div class="form-alineado">
        <label for="pais">País de residencia:</label>
        <input id="pais" name="pais" title="Solo se permiten letras y espacios. Mínimo 2 caracteres." />
      </div>
      <div class="form-alineado">
