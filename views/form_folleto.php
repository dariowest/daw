    ...
    <header>
      <nav>
        ...
        <ul>
          ...
          <li>
            <a href="perfil.html"
              ><i class="fas fa-user"></i> <span>Juan Dario</span></a
            >
          </li>
          <li>
            <a href="../index.html"
        ...
        <article>
          ...
          <form method="get" action="folleto.php">
            ...
            <p>
              <label for="telefono"
                >Telf:
                <input name="telefono" id="telefono" placeholder="Teléfono"
              /></label>
            </p>

            <p>
              <label for="color"
                >Color portada: <input name="color" id="color"
              /></label>
            </p>
            <p>
              <label
                >Número de copias: <input name="copias" id="copias"
              /></label>
            </p>
            <p>
              <label for="reso"
                >Resolucion: <input name="reso" id="reso" /><output id="valor"
                  >150</output
                ></label
              >
            </p>
